...
Configuration::Configuration(const std::string & _name): name(_name)
{
    ...
    audio       = 2;
    handicap    = 0;
    scoreNames[0] = "JOH";          scoreValues[0] = 500;
    scoreNames[1] = "MAD";          scoreValues[1] = 400;
    scoreNames[2] = "CHA";          scoreValues[2] = 250;
    scoreNames[3] = "BEN";          scoreValues[3] = 200;
    scoreNames[4] = "VAL";          scoreValues[4] = 150;
    scoreNames[5] = "MAR";          scoreValues[5] = 100;
    scoreNames[6] = "FRE";          scoreValues[6] = 75;
    scoreNames[7] = "CAR";          scoreValues[7] = 50;
    scoreNames[8] = "VIN";          scoreValues[8] = 25;
    scoreNames[9] = "LAU";          scoreValues[9] = 10;
}
